  ...
  return (
    <div className="flex relative justify-center items-center min-h-screen">
      ...
      <div className="flex justify-center items-center w-full h-full">
        <Card className="mx-auto sm:w-[48rem] h-[40rem] sm:h-fit overflow-y-auto w-[calc(100vw-1rem)] border border-muted-foreground bg-white bg-opacity-10 shadow-xl backdrop-blur-xl">
