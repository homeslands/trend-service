...
export class CreateProductRequestDto {
  ...
  @AutoMap()
  @ApiProperty({
    description: 'The option allow staff to set custom price when ordering',
    example: false,
    required: false,
  })
  @IsOptional()
...
export class UpdateProductRequestDto {
  ...
  @IsNotEmpty({ message: 'The isCustomPrice field is required' })
  @IsBoolean()
  @Type(() => Boolean)
  isCustomPrice: boolean;
}
...
export class GetProductRequestDto extends BaseQueryDto {
  ...
  @AutoMap()
  @ApiProperty({
    description: 'Get products base on voucher campaign template',
    example: '',
    required: false,
  })
  @IsOptional()
  voucherCampaignTemplate?: string;

  @AutoMap()
  @ApiProperty({
    description:
      'Get products that are either applied to a voucher campaign template or not',
    example: '',
    required: false,
  })
  @IsOptional()
  ...
  isAppliedVoucherCampaignTemplate?: boolean;
