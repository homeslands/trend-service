...
export const PRODUCT_HIDDEN_FAILED = 'PRODUCT_HIDDEN_FAILED';
...
const ProductValidation: TProductErrorCode = {
  ...
  PRODUCT_HIDDEN_FAILED: createErrorCode(115011, 'Failed to hide product'),
};
