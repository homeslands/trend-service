...
import { CampaignValidation } from 'src/campaign/campaign.validation';
...
import { QrPaymentValidation } from 'src/qr-payment/qr-payment.validation';
...
import { PrinterConnectorValidation } from 'src/printer-connector/printer-connector.validation';
...
export const AppValidation: TErrorCode = {
  ...
  ...MembershipCardValidation,
  ...PrinterConnectorValidation,
  ...QrPaymentValidation,
  ...CampaignValidation,
};
