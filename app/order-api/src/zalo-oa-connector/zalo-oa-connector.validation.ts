...
export const ERROR_INITIATE_SMS_BIRTHDAY_BY_MULTI_CHANNEL_MESSAGE =
  'ERROR_INITIATE_SMS_BIRTHDAY_BY_MULTI_CHANNEL_MESSAGE';
export const ZALO_OA_CONNECTOR_HISTORY_TOKEN_ID_REQUIRED =
  'ZALO_OA_CONNECTOR_HISTORY_TOKEN_ID_REQUIRED';
...
export type TZaloOaConnectorErrorCodeKey =
  ...
  | typeof ERROR_INITIATE_SMS_BIRTHDAY_BY_MULTI_CHANNEL_MESSAGE
  | typeof ZALO_OA_CONNECTOR_HISTORY_TOKEN_ID_REQUIRED;
...
export const ZaloOaConnectorValidation: TZaloOaConnectorErrorCode = {
  ...
  ERROR_INITIATE_SMS_BIRTHDAY_BY_MULTI_CHANNEL_MESSAGE: createErrorCode(
    158710,
    'Error when initiate sms birthday by multi channel message',
  ),
  ZALO_OA_CONNECTOR_HISTORY_TOKEN_ID_REQUIRED: createErrorCode(
    158711,
    'Token id is required for non-birthday zalo oa connector history',
  ),
};
