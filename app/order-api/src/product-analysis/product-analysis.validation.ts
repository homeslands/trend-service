...
export const EXPORT_PRODUCT_ANALYSIS_ERROR = 'EXPORT_PRODUCT_ANALYSIS_ERROR';
...
export type TProductAnalysisErrorCodeKey =
  ...
  | typeof EXPORT_PRODUCT_ANALYSIS_ERROR;
...
export const ProductAnalysisValidation: TProductAnalysisErrorCode = {
  ...
  EXPORT_PRODUCT_ANALYSIS_ERROR: createErrorCode(
    139505,
    'Error when exporting product analysis',
  ),
};
