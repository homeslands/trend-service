...
import { CoinCampaignTemplate } from './coin-campaign-template.entity';
...
export class Campaign extends Base {
  ...
  @OneToOne(() => CoinCampaignTemplate, (template) => template.campaign, {
    nullable: true,
    cascade: ['insert', 'update'],
  })
  @JoinColumn({ name: 'coin_campaign_template_column' })
  coinCampaignTemplate?: CoinCampaignTemplate;
