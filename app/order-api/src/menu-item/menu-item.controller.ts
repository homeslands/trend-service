...
export class MenuItemController {
  ...
  async findAll(
    ...
    const result = await this.menuItemService.findAll(query, currentUserDto);
    return {
      message: 'Retrieve all menu items successfully',
      statusCode: HttpStatus.OK,
      timestamp: new Date().toISOString(),
      result,
    } as AppResponseDto<AppPaginatedResponseDto<MenuItemResponseDto>>;
  }

  @Get('public')
  @Public()
  @ApiOperation({ summary: 'Retrieve all menu items public' })
  @ApiResponseWithType({
    type: MenuItemResponseDto,
    isArray: true,
    description: 'Retrieve all menu items',
  ...
  async findAllPublic(
    ...
    const result = await this.menuItemService.findAllPublic(query);
    return {
      message: 'Retrieve all menu items successfully',
      statusCode: HttpStatus.OK,
      timestamp: new Date().toISOString(),
